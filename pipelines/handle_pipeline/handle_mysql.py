...
from processes.handle_process.mysql_process import select_global_consumer, insert_airflow_result
...
with DAG(dag_id="handle_mysql",
    ...
    t1 = select_global_consumer()
    t2 = insert_airflow_result()
